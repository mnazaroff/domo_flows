#production_bag_total_count_per_shift.py
#==============================================================================
#queries production total bag count per shift JSON data and streams it to a
#Domo cloud data set
#==============================================================================
...
def main():
    try:
        #grab JSON data
        print("grabbing bag_total_count_per_shift JSON data...")
        
        url = 'https://io.moonlightcompanies.com/Bag_Total_Count_Per_Shift?Token=CAB160DD-55C1-4AA9-9E28-2DBC55E91C2A'
        ...
        print("bag_total_count_per_shift_json_pull JSON data grab successful")
        ...
        dataset_name = "Production Bag Total Count Per Shift"        
